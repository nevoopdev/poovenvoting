...
export default class Registration extends Component {
  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      console.log(await instance.methods.getAdmin().call());
      console.log(await instance.methods.getAdminName().call());
      console.log("beforeeee" + this.state.account);
      this.setState({ loopp: "hgfh" });
      // Total number of candidates
      const candidateCount = await this.state.ElectionInstance.methods
        .getTotalCandidate()
        .call();
      this.setState({ candidateCount: candidateCount });
      console.log("candid" + this.state.candidateCount);
      // Admin account and verification
      const admin = await this.state.ElectionInstance.methods.getAdmin().call();
      if (this.state.account === admin) {
        this.setState({ isAdmin: true });
        console.log("admin = " + (await this.state.account));
      }
      ...
      console.log("voter count = " + (await this.state.voterCount));
